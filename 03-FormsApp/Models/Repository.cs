namespace FormsApp.Models
{
    public class Repository
    {
        ...
        static Repository()
        {
            ...
            _products.Add(new Product { ProductId = 5, Name = "MacBook Air", Price = 80000, IsActive = true, Image = "8.jpg", CategoryId = 2 });
            _products.Add(new Product { ProductId = 6, Name = "MacBook Pro", Price = 90000, IsActive = true, Image = "9.jpg", CategoryId = 2 });
